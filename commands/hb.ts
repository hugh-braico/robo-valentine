...
export async function execute(interaction: ChatInputCommandInteraction, client: Client): Promise<void> {
    ...
    if (characterName === "") {
        ...
        await logResultToChannel(interaction, client, "hb", "❌ Character name resolved to empty string.");
        return;
    }
    ...
    if (moveName === "") {
        ...
        await logResultToChannel(interaction, client, "hb", "❌ Move name resolved to empty string.");
        return;
    }
