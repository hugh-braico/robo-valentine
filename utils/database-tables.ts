...
export async function initDatabase(): Promise<void> {
    ...
    // Create macros table
    console.log("  Initalising Macros table.");
    Macro.init(
        {
            Key: {
    ...
    console.log("  Initalising Characters table.");
    Character.init(
        {
            Name: {
                type: DataTypes.STRING,
    ...
    console.log("  Initalising Moves table.");
    Move.init(
        {
            Character: {
                type: DataTypes.STRING,
    ...
    console.log("  Initalising SimpleAliases table.");
    SimpleAlias.init(
        {
            Character: {
                type: DataTypes.STRING,
    ...
    console.log("  Initalising RegexAliases table.");
    RegexAlias.init(
        {
            Character: {
                type: DataTypes.STRING,
